...
const AddCourse = ({ title, open, onCancel, onOk, titleCancel = 'Hủy', titleOk = 'Lưu' }) => {
    ...
    return (
        ...
        >
            <Form
                ...
                autoComplete="off"
            >
                <p className="title-card" style={{ fontWeight: 600, fontSize: '14px', lineHeight: '20px' }}>Name of course</p>


                <Form.Item name="name" style={{ width: '100%' }}>
                    <Input placeholder="" style={{ width: '350px' }} />
                </Form.Item>
                <p className="title-card" style={{ fontWeight: 600, fontSize: '14px', lineHeight: '20px' }}>Description</p>

                <Form.Item name="description" style={{ width: '100%' }}>
                    <TextArea rows={4} placeholder="" maxLength={6} style={{ minWidth: '350px' }} />
                </Form.Item>
                <Divider />
